...
const validateEmail = (email) => {
  return /^[a-zA-z0-9]*\b[@]\b([a-zA-z0-9]*)\b[\.]\b((com)|(net)|(org))\b|^[a-zA-z0-9]*\b[\.]\b[a-zA-z0-9]*\b[@]\b([a-zA-z0-9]*)\b[\.]\b((com)|(net)|(org))/gm.test(email);
};
...
const validatePhoneNumber = (phoneNumber) => {
  return /^\([\d]{3}\)\ [\d]{3}\-[\d]{4}$|^\([\d]{3}\)[\d]{3}\ [\d]{4}$|^[\d]{3}\ [\d]{3}\-[\d]{4}$|^[\d]{3}\-[\d]{7}$|^[\d]{3}\-[\d]{3}\ [\d]{4}$|^[\d]{3}\-[\d]{3}\-[\d]{4}$|^[\d]{3}\ [\d]{3}\ [\d]{4}$|^[\d]{6}\-[\d]{4}$|^[\d]{3}\ [\d]{7}$|^[\d]{10}$/gm.test(phoneNumber);
};
